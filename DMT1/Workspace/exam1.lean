...
- A. (P → Q) → (Q → P) NOT VALID
-- counterexample is ⟦P⟧ = true ∧ ⟦Q⟧ = false
-- when P is false and Q is true, then P → Q is true, but Q → P is false
...
- E. (P ∨ Q) → (P ∧ Q) NOT VALID
-- counterexample is ⟦P⟧ = true ∧ ⟦Q⟧ = false
-- when P is true and Q is false, then P ∨ Q is true, but P ∧ Q is false
...
-- if it implies false it is not provable, lean will not accept.
/-
...
-- it asserts a concrete disjunction and an implication with no assumptions, lean will not accept.
/-
...
fun pq pnq =>
  fun p =>  -- assume P proves False
    let q := pq p    -- from P → Q and p:P, get q:Q
    let nq := pnq p  -- from P → ¬Q and p:P, get nq:¬Q
    nq q            -- apply ¬Q to Q
...
- Assume P → Q and P → ¬Q
- To prove ¬P, assume P
- From P → Q and P, get Q
- From P → ¬Q and P, get ¬Q
- Having both Q and ¬Q is a contradiction
- Finally, ¬P!
@@@ -/
